    ...
    <section className="relative min-h-screen flex items-center justify-center px-6 pt-16 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        >
          ...
          Engenharia de agentes autonomos
        </motion.div>
        ...
        >
          Automatize operacoes complexas com agentes de IA{" "}
        ...
        >
          Analisamos seus processos, identificamos os gargalos e entregamos agentes
          autonomos que executam tarefas criticas — de forma confiavel, escalavel
          e integrada ao seu stack.
        </motion.p>
